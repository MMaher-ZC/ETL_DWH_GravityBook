...
max(case when [status_id]=1 then cast([status_date] as time(0)) end ) as 'D1_time',
max(case when [status_id]=2 then cast([status_date] as date) end ) as 'D2_date',
max(case when [status_id]=2 then cast([status_date] as time(0)) end ) as 'D2_time',
max(case when [status_id]=3 then cast([status_date] as date) end ) as 'D3_date',
max(case when [status_id]=3 then cast([status_date] as time(0)) end ) as 'D3_time',
max(case when [status_id]=4 then cast([status_date] as date) end ) as 'D4_date',
max(case when [status_id]=4 then cast([status_date] as time(0)) end ) as 'D4_time',
max(case when [status_id]=5 then cast([status_date] as date) end ) as 'D5_date',
max(case when [status_id]=5 then cast([status_date] as time(0)) end ) as 'D5_time',
max(case when [status_id]=6 then cast([status_date] as date) end ) as 'D6_date',
max(case when [status_id]=6 then cast([status_date] as time(0)) end ) as 'D6_time',
